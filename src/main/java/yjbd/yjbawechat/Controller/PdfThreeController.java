...
//        String PROCESS_DECISION = request.getParameter("PROCESS_DECISION");
        ...
        responseText = pdfThreeService.createZeLingBiao(TIME_IDS,EXECUTE_PEOPLE2,CARD_NUMBER2,CHECKE_UNIT, EXECUTE_PEOPLE,CARD_NUMBER,CHECKE_PROBLEM_IDS,CHECKED_END_TIME,RECORD_ID);
        return responseText;
    }
