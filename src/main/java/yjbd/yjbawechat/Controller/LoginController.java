...
public class LoginController {
    ...
    //执法文书预览页面
    @RequestMapping("/TestSuccessView")
    public String TestSuccessView(){return "/ThreePdf/TestSuccessView";}
    ...
    //使用复选框
    @RequestMapping("/SelectOtherPdf")
    public String SelectOtherPdf(){return "/Record/SelectOtherPdf";}
