...
public class PunishMeasureController {
    ...
    public void setPunishMeasureInfo(HttpServletRequest request){
        ...
        String RECORD_ID=request.getParameter("RECORD_ID");
        punishMeasureService.setPunishMeasureInfo(PROCESS_DECISION,CHECKE_DETAIL,CHECKE_UNIT,CHECKED_START_TIME,RECORD_ID);
    ...
    public String setTemporaryPunishMeasureInfo(HttpServletRequest request){
        ...
        responseText =punishMeasureService.setTemporaryPunishMeasureInfo(RECORD_ID,PROCESS_DECISION,CHECKE_DETAIL,CHECKE_UNIT,CHECKED_START_TIME,URL);
        return responseText;
    }
