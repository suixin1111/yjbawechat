...
//        String PROCESS_DECISION = request.getParameter("PROCESS_DECISION");
        ...
        String checkUnit = fireIndexService.getCheckUnit(RECORD_ID);
        responseText = timeLimitService.createTimeLimitTable(TIME_IDS,EXECUTE_PEOPLE2,CARD_NUMBER2,CHECKE_UNIT, EXECUTE_PEOPLE,CARD_NUMBER,CHECKE_DETAIL,RECORD_ID,checkUnit);
        return responseText;
    }
    /**
     * 上传执法者签名
...
//            String RecordId="10";
            ...
            e.printStackTrace();
            return yjbd.yjbawechat.Util.MsgUtil.errorMsg(e.toString());
        }
    }
    /**
     * 最后生成PDF页面以及二维码图片
