...
public class UploadFileController {
    ...
    public Map<String,Object> uploadPic(@RequestParam("file")MultipartFile file){
        String path = yjbd.yjbawechat.Enum.PathEnum.IMAGES_PATH.getPath()+"/"+"firefighting";
        yjbd.yjbawechat.VO.ResultVO<String> resultVO = yjbd.yjbawechat.Util.UploadFileUtil.uploadFile(file,path);
    ...
    public Map<String,Object> uploadVideo(@RequestParam("file")MultipartFile file){
        String path = yjbd.yjbawechat.Enum.PathEnum.VIDEO_PATH.getPath()+"/"+"firefighting";
        yjbd.yjbawechat.VO.ResultVO<String> resultVO = yjbd.yjbawechat.Util.UploadFileUtil.uploadFile(file,path);
        Map<String,Object> map = new HashMap<>(16);
        map.put("msg",resultVO.getMsg());
        map.put("url","../firefighting"+resultVO.getData());
    ...
    public Map<String,Object> uploadCheckSign(@RequestParam("file")MultipartFile file,
        ...
        String path = yjbd.yjbawechat.Enum.PathEnum.IMAGES_PATH.getPath()+"/"+"sign";
        yjbd.yjbawechat.VO.ResultVO<String> resultVO = yjbd.yjbawechat.Util.UploadFileUtil.uploadFile(file,path);
        yjbd.yjbawechat.VO.ResultVO result = fireIndexService.updateCheckSign(resultVO.getData(),CREATE_TIME);
        Map<String,Object> map = new HashMap<>(16);
    ...
    public Map<String,Object> uploadCheckedSign(@RequestParam("file")MultipartFile file,
        ...
        String path = yjbd.yjbawechat.Enum.PathEnum.IMAGES_PATH.getPath()+"/"+"sign";
        yjbd.yjbawechat.VO.ResultVO<String> resultVO = yjbd.yjbawechat.Util.UploadFileUtil.uploadFile(file,path);
        yjbd.yjbawechat.VO.ResultVO result = fireIndexService.updateCheckedSign(resultVO.getData(),CREATE_TIME);
        Map<String,Object> map = new HashMap<>(16);
        if(result.getMsg()=="提交成功"){
            map.put("saveMsg",resultVO.getMsg());
        }
