...
public class FireLoginController {
    ...
    @RequestMapping("/previewQrLimit")
    public String previewQrLimit(){return "FireFighting/timeLimit/previewQr";}

    @RequestMapping("/creatPdfWithSign")
    public String creatPdfWithSign(){return "FireFighting/timeLimit/creatPdfWithSign";}
    /**
     * 九小场所现场整改页面
     */
    //现场整改检查页面
    ...
    @RequestMapping("/previewQr")
    public String previewQr(){return "FireFighting/SiteRectification/previewQr";}
    @RequestMapping("/pdfWithSign")
    public String pdfWithSign(){return "FireFighting/SiteRectification/pdfWithSign";}
    //检查者签名页面
