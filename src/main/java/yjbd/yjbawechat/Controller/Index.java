...
//        String CHECKED_END_TIME = request.getParameter("CHECKED_END_TIME");
    ...
    public String zjCreateEnforce2(HttpServletRequest request){
        ...
        response = indexService.zjCreateEnforceService(CHECKED_UNIT,ADDRESS,REPRESENT_PEOPLE, USER_ID,UNIT_NUMBER,S_CODE);
        return  response;
    }
    ...
    public String exCreateEnforce2(HttpServletRequest request){
        ...
        String   UNIT_NUMBER=request.getParameter("UNIT_NUMBER");
        String S_CODE = request.getParameter("S_CODE");
        response = indexService.exCreateEnforceService(CHECKED_UNIT,ADDRESS,REPRESENT_PEOPLE, USER_ID,UNIT_NUMBER,S_CODE);
        return  response;
    }
